    ...
    <div class="container">
        ...
        <aside class="sidebar">
            ...
            <div class="menu-top">
                ...
                <a href="/baseleap/my-page/search" class="menu-icon" title="유저 검색"><svg xmlns="http://www.w3.org/2000/svg"
        ...
        <main class="content">
            <div class="post-summary">
                ...
                <h2>${userNickname}'s Guestbook
                    <a href="#" class="menu-icon" title="메시지보내기버튼"><svg xmlns="http://www.w3.org/2000/svg" width="16"
