...
<div class="container">
	...
	<aside class="sidebar">
		...
		<div class="user-profile">
			<a href="/baseleap/home/page?pageUserId=${sessionScope.loginUserId}">
				<img src="/image/${userInfo.profileImage}" alt="Profile Picture" class="profile-picture">
			</a>
			<div class="user-info">
				<h2>${userInfo.nickname}'s HomePage</h2>
				<hr>
